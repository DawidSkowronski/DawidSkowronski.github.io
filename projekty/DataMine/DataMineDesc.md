...
#### Zakres analizy:
* **Analiza opisowa (Autor: [Dawid Skowroński](https://github.com/DawidSkowronski)):** 
...
* **Analiza opisowa z podziałem na grupy (Autor: [Mateusz Cieślak](https://github.com/matcie0)):**
...
####  Zakres analizy:
* **Dyskretyzacja Nienadzorowana - Zbiór Iris (Autor: [Dawid Skowroński](https://github.com/DawidSkowronski)):**
...
* **Analiza Głównych Składowych (PCA) - City Quality of Life (Autor: [Mateusz Cieślak](https://github.com/matcie0)):**
...
* **Skalowanie Wielowymiarowe (MDS) - Case Study: Titanic (Autor: [Dawid Skowroński](https://github.com/DawidSkowronski)):**
...
#### Zakres analizy:
* **Rozszerzona Przestrzeń Cech - Zbiór Iris (Autor: [Dawid Skowroński](https://github.com/DawidSkowronski)):**
  * Konstrukcja klasyfikatora opartego na regresji liniowej.
  * Konstrukcja modelu liniowego dla rozszerzonej przestrzeni cech.

* **Modelowanie i Optymalizacja - Zbiór Vehicle (Autorzy: [Mateusz Cieślak](https://github.com/matcie0) i [Dawid Skowroński](https://github.com/DawidSkowronski)):**
...
* **Zadanie 1: Zaawansowana Klasyfikacja (Supervised Learning) (Autor: [Mateusz Cieślak](https://github.com/matcie0)):**
...
* **Zadanie 2: Analiza Skupień (Unsupervised Learning) (Autorzy: [Dawid Skowroński](https://github.com/DawidSkowronski) i [Mateusz Cieślak](https://github.com/matcie0)):**
